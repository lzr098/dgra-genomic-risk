...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/code-16K+-lines-green" alt="code">
  <img src="https://img.shields.io/badge/tests-5.6K+-lines-brightgreen" alt="tests">
  <img src="https://img.shields.io/badge/offline_archive-821_genes-orange" alt="archive">
  <img src="https://img.shields.io/badge/license-MIT--0-informational" alt="license">
</p>
...
```
在线查询 → 内存缓存 → SQLite(30d TTL) → 离线 JSON(821基因) → 硬编码安全列表 → 保守规则
```

断网/限流/被封 IP → GPA 仍能产出报告（置信度标记为 LOW），不会卡死。
...
│   └── offline_data/                # 821 基因离线归档（239 MB）
├── tests/                           # 5,605 行测试
