...
# =============================================================================
# v0.8.1: Chinese Column Header → DGRA Canonical Column Mapping
# =============================================================================
# Maps Chinese-language VEP/annotation column headers to dgra_core REQUIRED_COLS.
# The Chinese VEP CSV format commonly used in Chinese clinical genomics pipelines
# does not include gnomAD_AF or VAF columns — these must be sourced from
# external APIs or the original VCF INFO field.

CHINESE_COLUMN_MAP_V2 = {
...
def _translate_single_cn_header(cn_header: str) -> str:
    ...
    # Exact match
    if clean in CHINESE_COLUMN_MAP_V2:
        return CHINESE_COLUMN_MAP_V2[clean]

    # Fuzzy match: try stripping parenthetical suffixes
    for cn_key, dgra_key in CHINESE_COLUMN_MAP_V2.items():
